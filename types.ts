...
export enum AbsenceReason {
  ...
  RESERVA = 'RESERVA',
  ARTICULO_93 = 'ARTICULO 93',
  DIA_ESTUDIANTIL = 'DIA ESTUDIANTIL',
  DIA_ANT_ESTUDIANTIL = 'DIA ANT ESTUDIANTIL',
...
export interface StaffMember {
  ...
  name: string;
  status: StaffStatus;
  role?: 'CHOFER' | 'AUXILIAR' | 'ENCARGADO' | 'BALANCERO' | 'LONERO' | 'MAQUINISTA';
